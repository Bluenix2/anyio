...
class TaskGroup(metaclass=ABCMeta):
    ...
    async def spawn(self, func: Callable[..., Awaitable[object]],
    ...
    @abstractmethod
    def start_soon(self, func: Callable[..., Awaitable[object]],
                   *args: object, name: object = None) -> None:
        """
        Start a new task in this task group.
    ...
    @abstractmethod
    async def start(self, func: Callable[..., Awaitable[object]],
